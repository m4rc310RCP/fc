...
//--------------------------------------------------
// @GraphQLQuery(name=ERROR$date_after_of_open_transaction_cycle, description=DESC$error_date_after_of_open_transaction_cycle)
	public static final String ERROR$date_after_of_open_transaction_cycle = "${error.date.after.of.open.transaction.cycle}";
//--------------------------------------------------
// @GraphQLQuery(name=ERROR$has_open_transaction_cycle, description=DESC$error_has_open_transaction_cycle)
	public static final String ERROR$has_open_transaction_cycle           = "${error.has.open.transaction.cycle}";
//--------------------------------------------------
// @GraphQLQuery(name=ERROR$no_active_transaction_cycle, description=DESC$error_no_active_transaction_cycle)
	public static final String ERROR$no_active_transaction_cycle          = "${error.no.active.transaction.cycle}";
//--------------------------------------------------
// @GraphQLQuery(name=IDENTIFY$serie, description=DESC$identify_serie)
	public static final String IDENTIFY$serie                             = "${identify.serie}";
//--------------------------------------------------
...
//--------------------------------------------------
// @GraphQLType(name=TYPE$document, description=DESC$type_document)
	public static final String TYPE$document                              = "${type.document}";
//--------------------------------------------------
// @GraphQLType(name=TYPE$operation, description=DESC$type_operation)
	public static final String TYPE$operation                             = "${type.operation}";
//--------------------------------------------------
